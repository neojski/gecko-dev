...
let tests = [
  // For migrated values we set timestamp to NULL. Remove since should not affect them.
  function removeSinceNotAffectMigratedRows() {
    ...
    // Test that migrated prefs are not removed by removeAllDomainsSince.
